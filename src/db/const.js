...
export const static_content = {
    about_us: "<p>Nair & Associates is a leading national law firm with over 9 professionals operating out of office located in Indore. Nair & Associates is a full service Law Firm handling all legal matters on Civil, Criminal, Intellectual Property Rights, Business, Banking, Direct and Indirect Taxation, Corporate and Insolvency, Customs/Export Import, Arbitration, Labor and Industrial Employment, Competition, Constitution, Infrastructure and Investment, Cyber, Family, Property, Immigration, Consumer, Contract & Service, Aviation and Maritime subjects in law, in all courts as well  as Tribunals. An individualized service by members with over a decade of experience ensures total satisfaction to the clients.</p>" +
        "<p>The firm relies on the latest computing and communications equipment to enable fast and cost effective services to clients. It makes complete usage of a practical and effective precedent development system to ensure uniformity and time management. The firm has adapted itself successfully to the modern day demands of global competitiveness and competence.</p>" +
        "<p>The firm possesses a wealth of experience in the field of Law for the last 17 years and is staffed with a team of energetic professionals & lawyers and has associates representing the firm.   Our long experience has made us to understand that clients wish to minimize their involvement with the legal system. They put their full trust in the law firm representing them. We work together with our clients to avoid legal obstacles, and to handle legal problems in an efficient, professional manner when they do occur.</p>" +
        "<h3>Our USP?</h3>" +
...
export const clients = [
    ...
    'OMAXE LIMITED', 'PATEL MOTORS PRIVATE LIMITED', 'SHASHI HOSPITAL AND RESEARCH CENTRE', 'REDVISION COMPUTER TECHNOLOGIES PRIVATED LIMITED',
